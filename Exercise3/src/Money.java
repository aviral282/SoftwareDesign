...
class Money
	...
	public Money( ) {euro=0; cent=0;}
	public Money(int e, int c)	 {euro=e; cent=c;}
	public Money(Money  m)  {euro=m.euro; cent=m.cent;}
	...
	public int  total_in_cent( )  { return (cent + (euro *100));}
