...
public class ClockThreadSkel6  implements ActionListener{
    ...
    // public int counter;
     ...
     public ClockThreadSkel6() {    
                         ...
                         p1.add(time24); time24.setBackground(Color.yellow);
                         p2.add(stop24);	  stop24.setBackground(Color.yellow);
                         p2.add(restart24);	  restart24.setBackground(Color.yellow);
                         content.add(p1);
                         content.add(p2);
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	if (target==stop24) clockThread24.mySuspend();
    	if (target==restart24) clockThread24.myResume();
    }   
...
class Display24 extends Thread {
     ...
     public Display24(JLabel l1){l24=l1;}
